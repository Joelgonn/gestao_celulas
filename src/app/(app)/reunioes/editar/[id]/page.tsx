...
export default function EditReuniaoPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isDuplicate) {
                addToast({
                    ...
                    message: `Já existe outra reunião com o tema '${formData.tema}' na data ${formatDateForDisplay(formData.data_reuniao)}`
                });
                setSubmitting(false);
                return;
            }
        ...
        try {
            await atualizarReuniao(reuniaoId, {
                ...
                caminho_pdf: formData.caminho_pdf,
            });
            ...
            addToast({
                ...
                message: e.message || 'Erro desconhecido ao atualizar reunião'
            });
        } finally {
            setSubmitting(false);
        }
    ...
    const handleFileUpload = async () => {
        ...
        if (!reuniaoId) {
            addToast({
                type: 'error',
                title: 'ID não disponível',
                message: 'ID da reunião não disponível para upload'
            });
            return;
        }
        ...
        try {
            ...
            addToast({
                ...
                message: 'Material da reunião enviado e vinculado com sucesso',
                duration: 4000
            });
            ...
            addToast({
                ...
                message: e.message || 'Erro desconhecido ao fazer upload do material'
            });
            setUploadProgress(0);
        } finally {
            setUploading(false);
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                        ...
                                        <select 
                                            ...
                                            onChange={handleChange} 
                                            required 
                                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 bg-white"
                                        >
                                ...
                                <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                                    ...
                                    {formData.caminho_pdf && (
                                        <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-blue-200 mb-4">
                                            <div className="flex items-center space-x-3">
                                                <svg className="w-8 h-8 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                                                </svg>
                                                <div>
                                                    <p className="text-sm font-medium text-gray-900">Material atual disponível</p>
