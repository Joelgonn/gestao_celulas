    ...
    useEffect(() => {
        const fetchPresencaData = async () => {
            ...
            try {
                ...
                setMinistradorPrincipalId(fetchedReuniao.ministrador_principal);
                setMinistradorSecundarioId(fetchedReuniao.ministrador_secundario);
                setResponsavelKidsId(fetchedReuniao.responsavel_kids);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await Promise.all(membrosPresenca.map(async (membro) => {
                ...
                return registrarPresencaMembro(reuniaoId, membro.id, membro.presente || isSpecialRole);
            }));
